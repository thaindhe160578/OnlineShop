                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner pt-3">
                            ...
                            <form name ="form1" class="row login_form pt-2" action="register" method="post" id="contactForm">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="tel" class="form-control" id="tel" name="num" pattern="/(0[3|5|7|8|9])+([0-9]{8})\b/g" placeholder="Phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone'" required>
                                </div>
